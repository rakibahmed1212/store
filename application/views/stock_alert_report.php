    ...
    <div class="row">
        <div style="margin-bottom:25px;" class="col-xs-12 no-print">
            <div class="col-md-12">
                ...
                <button type="button" onclick="show_modal_page('<?php echo base_url();?>stock_alert_report/popup/add_stock_model')" class="btn btn-primary btn-flat btn-lg pull-right" ><i class="fa fa-plus-square" aria-hidden="true"></i>
                    Add new stock
                </button>
            </div>
        </div>
