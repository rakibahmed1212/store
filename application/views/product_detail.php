                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php
                                        $data = array('class'=>'form-control input-lg','type'=>'number','id'=>'total_selling','name'=>'total_retail','value'=>$product[0]->packsize*$product[0]->retail,'reqiured'=>'');
                                        echo form_input($data);
                                ?>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php               
                                $data = array('class'=>'form-control input-lg','type'=>'number','id'=>'total_purchase','name'=>'total_cost','value'=>$product[0]->packsize*$product[0]->purchase,'reqiured'=>'');
                                echo form_input($data);         
                            ?>
                            </div>
